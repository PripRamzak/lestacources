...
public:
    ...
    bool initialize() final
    {
        ...
        try
        {
            vertex_shader_file.open("./52-matrices/vertex_shader.glsl");
        ...
        try
        {
            fragment_shader_file.open("./52-matrices/fragment_shader.glsl");
    ...
    bool load_texture() final
    {
        ...
        unsigned char* image = stbi_load(
            "./52-matrices/knight.png", &width, &height, &channels, 0);
        if (image == nullptr)
        {
